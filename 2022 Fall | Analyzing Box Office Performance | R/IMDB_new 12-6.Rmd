...
#, -content_rating, -tomatometer_status, -comedy, - action, -scifi, -documentary, -drama, -horror, -romance, -crime, -adventure, -mystery, -biography, -thriller
...
The ANOVA test indicates that the increases in variance between the models are signficant with very low p-values. This can be confirmed by looking at the p-values for each model, being less than .05. However, when looking at the $R^2$ values, the 2nd and 4th models accounts for approximately .43 of the variance, and the difference is negligible. The 2nd model uses 7 variables, whereas the 4th model uses 14.
